...
export const CHARTS_RUNTIME = [
    ...
    '  }',
    '',
    '  // Circle swatches with breathing room before the label. Chart.js pads',
    '  // boxes, not text, so the gap is prepended to the string.',
    '  function legend(font) {',
    '    return {',
    ...
    '  }',
    '',
    '  function datasets(type, cfg, colors) {',
    ...
    '          borderRadius: 3, borderSkipped: false, maxBarThickness: 44 });',
    '      }',
    '    }',
    '    return out;',
    '  }',
    ...
    '      stacked: !!cfg.stacked };',
    '    var category = { grid: { display: false }, border: { color: grid },',
    ...
    '      type: type,',
    '      data: { labels: cfg.labels || [], datasets: datasets(type, cfg, colors) },',
    '      options: {',
    '        responsive: true,',
    ...
    '                align: "start", labels: legend(font) },',
    '          tooltip: {',
